...
void setup() {
  ...
  Serial.println(F("BME280 json & Pin Set"));
...
void handleRoot() {
  ...
  server.send(200, "application/json", "{\"temperature\": " + String(temperatureCString) +", \"humidity\": " + String(humidityString) + ", \"pressure\": " + String(pressureString) + "}");
}
